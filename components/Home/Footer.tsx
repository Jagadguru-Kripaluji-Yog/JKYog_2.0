...
import { FacebookIcon, InstaIcon, LinkedInIcon, LiveConnect, Mentor, PintrestIcon, PracticalTool, TwitterIcon, WhatAppIcon, YoutubeIcon } from '../icons';
    ...
    <>
      <div className='bg-[#fff3dd] px-[40px] relative   py-[100px] h-[631px] serif  rounded-t-[45px]'>
       ...
       <div className="flex flex-col gap-[40px] justify-center items-center ">
        <div className='flex flex-col gap-3'>   <h1 className='text-center text-[#291900] text-[44px] font-bold  leading-10  '>Swami Mukundananda Exclusive</h1>
            <p className='text-center text-[#645743] text-[18px] font-normal leading-6 lg:w-[800px] w-auto '>Swami Mukundananda Exclusive (Sex) is a community to provide knowledge, practical tools and tips addressing entire landscape of your life under 5 key themes.</p>
        </div>
     
        <button className="bg-[#EF6F1F] flex justify-center border-[#dad3c8] gap-[2px] rounded-3xl px-[16px] py-[10px]  text-white  ">Join SMEx</button>
        ...
        <div className='flex justify-center items-start gap-5 shrink-0 h-[352px] lg:overflow-hidden overflow-x-scroll lg:w-[1130px] w-auto absolute -bottom-4'>
         ...
         <div className='relative flex flex-col gap-8 p-8 bg-white rounded-t-[20px] h-[340px] w-[363px] items-center shrink-0'>
            ...
            <p className='leading-8 text-center serif text-[24px] font-bold text-[#291900] '>Assimilate Practical Tools and Techniques</p>
          </div>
          <div className='relative flex flex-col gap-8 p-8 bg-white rounded-t-[20px] h-[340px] w-[363px] items-center shrink-0'>
            <div className='absolute -top-3 rounded-t-[20px]  w-[284px] h-3 shrink-0 bg-white'></div>
            <LiveConnect className='w-[186px] h-[186px] shrink-0'/>
            <p className='leading-8 text-center serif text-[24px] font-bold text-[#291900] '>Regular Live Connect With Swamiji</p>
          </div>
          <div className='relative flex flex-col gap-8 p-8 bg-white rounded-t-[20px] h-[340px] w-[363px] items-center shrink-0'>
            <div className='absolute -top-3 rounded-t-[20px]  w-[284px] h-3 shrink-0 bg-white'></div>
            <Mentor className='w-[186px] h-[186px] shrink-0'/>
            <p className='leading-8 text-center serif text-[24px] font-bold text-[#291900] '>Choose Swamiji to be your Mentor</p>
          </div>
        </div>
        </div>
      </div>
            ...
            <div className='flex-2 relative'>
              <div className='flex flex-col gap-[56px]'>
                ...
                <div className="flex flex-col gap-3">
                  <h1 className='leading-8 lg:text-[28px] text-[20px] text-[#291900] font-bold serif   '>Subscribe to Our Newsletter</h1>
