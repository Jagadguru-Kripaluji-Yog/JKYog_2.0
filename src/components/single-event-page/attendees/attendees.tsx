...
const AttendeeCard: FC<(typeof attendees)[0]> = ({ src, name, organizer }) => {
  return (
    <div className="relative flex flex-col items-center min-w-[308px] gap-6 p-8 border border-border-primary rounded-[20px] bg-white">
      {organizer && (
...
const AttendeeCardOther: FC = () => {
  return (
    <div className="flex items-center p-8 border border-border-primary rounded-[20px] bg-white">
