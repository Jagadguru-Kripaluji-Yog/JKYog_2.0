        ...
        <div className="flex flex-col gap-[40px] justify-center items-center ">
          <div className="flex flex-col gap-3">
            ...
            <p className="text-center text-[#645743] text-[18px] font-normal leading-6 lg:w-[800px] w-auto ">
              Swami Mukundananda Exclusive (Sex) is a community to provide knowledge, practical tools and tips
              addressing entire landscape of your life under 5 key themes.
            </p>
          </div>
              ...
              <div className="flex flex-col gap-[56px]">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex gap-3 my-2 items-center">
                    <input type="radio" className="flex w-4 h-4 justify-center items-center gap-2  " />{' '}
