...
export const Form: FC = () => {
  ...
  return (
    <form className="flex flex-col gap-[14px] w-[346px]">
      <label className="flex justify-between bg-white border border-border-primary rounded-[56px] pl-5 py-2 pr-2">
        <input
          type="email"
          placeholder="Enter your email address"
          className="text-heading text-opacity-30 font-satoshi-medium w-full outline-none"
        />
        <button type="submit" className="rounded-full bg-button-primary hover:bg-orange-400 p-3">
