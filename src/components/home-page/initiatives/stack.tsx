                ...
                <div className="flex flex-col items-start gap-10 flex-[1_0_0] px-0 py-3">
                    ...
                    <div className="flex flex-col justify-center items-start gap-3 self-stretch">
                        ...
                        <p className="text-[#645743] self-stretch text-lg not-italic font-normal leading-6">
                            Bhagavad Gita is one of the most revered scriptures!
                            Grasp the wisdom embedded in this precious jewel.
                            Watch verse by verse shloka and translation followed
                            by full commentary written by Swami Mukundananda.
                        </p>
                    </div>
