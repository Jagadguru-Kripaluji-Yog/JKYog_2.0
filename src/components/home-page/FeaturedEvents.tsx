...
const FeaturedEvents = () => {
  ...
  useEffect(() => {
    const getEvents = async () => {
      const response = await axios.get('https://prod-strapi.jkyog.org/api/webapp-featured-events?populate=image');
              ...
              >
                ...
                >
                  <div className="inline-flex items-center gap-1 px-2 py-1 rounded-3xl bg-[#fffbf2] mt-[12px] ml-[12px]">
                    <p className="text-[#EF6F1F] text-center text-xs not-italic font-bold leading-4">tags</p>
                  </div>
                </div>
