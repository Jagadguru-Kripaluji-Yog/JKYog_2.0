...
const Form: FC = () => {
  return (
    <div className="flex flex-col justify-center items-center lg:items-start xl:pr-[116px] gap-10 flex-[1_0_0] self-stretch ">
      <div className="flex flex-col justify-center items-center gap-8 self-stretch">
        ...
        <div className="flex flex-col items-center gap-4 self-stretch">
          <input
            type="text"
            className="flex items-start self-stretch px-5 py-3.5 rounded-[56px] border-[1.25px] border-solid border-border-color bg-transparent"
