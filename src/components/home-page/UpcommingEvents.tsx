...
const UpcommingEvents = () => {
  ...
  useEffect(() => {
    const getEvents = async () => {
      const response = await axios.get('https://prod-strapi.jkyog.org/api/web-app-upcoming-events?populate=image');
  ...
  return (
    <div className="flex flex-col items-center gap-10 self-stretch">
      <p className="text-[#291900] text-[44px] self-stretch not-italic font-bold leading-[56px]">Upcoming Events</p>
      {/* cards */}
