...
export const FeaturedEventCard: FC<FeaturedEventData['attributes']> = ({ image, heading, place, date }) => {
  return (
    <div className="flex flex-col items-start p-2 border rounded-[20px] border-solid border-border-primary bg-white mr-3 lg:mr-5 h-full">
      ...
      <div className="flex items-center gap-2.5 self-stretch p-4 flex-1">
