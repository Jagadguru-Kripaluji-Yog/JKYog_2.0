...
import { ArrowRight, Instagram, Facebook, Linkdin, Pintrest, X, Youtube } from '@/src/components/icons';
const LeftStack = () => {
  return (
    <div className="flex  w-[346px] flex-col justify-between items-start self-stretch">
      {/* form */}
      <div className="flex flex-col items-start gap-14">
        <img src="./logo.png" alt="" className="flex items-start gap-[9.687px]" />
        <div className="flex flex-col mt-8 gap-4">
          <h1 className="leading-8 lg:text-[28px] text-[20px] text-heading font-bold   ">
        ...
        <div className="flex flex-col items-start gap-4 self-stretch">
          <p className="text-heading text-xl not-italic font-bold leading-7">Connect With Us</p>
